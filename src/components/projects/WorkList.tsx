...
import { WorkListInteractive } from "./WorkListInteractive";
    ...
    <Section id="work" variant="ink" grain transition="slide-right">
      ...
      >
        <div className="flex items-end justify-between mb-2 sm:mb-4">
          ...
          />
          <p className="text-[13px] text-fg-soft mb-2">{sorted.length} projects</p>
        </div>
        <p data-reveal className="text-fg-faint text-sm mb-6 hidden sm:block">
          Hover a project to preview it.
        </p>

        <WorkListInteractive items={sorted} />
      </div>
    </Section>
  );
}
